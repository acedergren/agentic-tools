...
| **oci/best-practices** | OCI architecture review router | v2.0.0 |
| **oci/compute-management** | OCI Compute operations | v2.0.0 |
| **oci/networking-management** | OCI Networking operations | v2.0.0 |
| **oci/iam-identity-management** | OCI IAM and identity | v2.0.0 |
| **oci/infrastructure-as-code** | OCI Terraform hub | v2.0.0 |
...
| **oci/oracle-idcs-org-provisioning** | IDCS org provisioning | v1.0.0 |
| **oci/sqlite-to-oracle-planner** | SQLite to Oracle migration | v1.0.0 |
