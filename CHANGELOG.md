...
- Added CI quality gates for skill validation, install smoke testing, and secret scanning under `scripts/ci/` and `.github/workflows/skill-quality.yml`.
...
- Hardened skill registry validation to compare filesystem, docs, JS CLI entries, and Bash installer entries consistently.
